...
import { BaseInputAdapter } from '@game-engine/core/input/BaseInputAdapter';
import type { IInputAdapter, InputAdapterType, InputAttachOptions, InputCapabilities } from '@game-engine/core/interfaces';
