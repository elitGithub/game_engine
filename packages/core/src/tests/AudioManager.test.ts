...
import { MusicPlayer } from '@game-engine/core/audio/MusicPlayer';
import { SfxPool } from '@game-engine/core/audio/SfxPool';
import { VoicePlayer } from '@game-engine/core/audio/VoicePlayer';
import type { ITimerProvider } from '@game-engine/core/interfaces';
import type { IAudioContext } from '@game-engine/core/interfaces/IAudioPlatform';
...
vi.mock('@game-engine/core/audio/MusicPlayer');
vi.mock('@game-engine/core/audio/SfxPool');
vi.mock('@game-engine/core/audio/VoicePlayer');
