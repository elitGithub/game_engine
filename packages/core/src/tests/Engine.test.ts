...
import type { ISerializable } from '@game-engine/core/types';
...
import { HeadlessPlatformAdapter } from '@game-engine/core/platform/HeadlessPlatformAdapter';
import { createCoreSystemDefinitions } from '@game-engine/core/core/CoreSystemDefs';
