...
import { BrowserPlatformAdapter } from '@game-engine/core/platform/BrowserPlatformAdapter';
import type { BrowserPlatformConfig } from '@game-engine/core/platform/BrowserPlatformAdapter';
