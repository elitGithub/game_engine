...
import { CanvasEffectTarget } from '@game-engine/core/rendering/CanvasEffectTarget';
// FIX: Import TextStyleData
import type { RenderCommand, TextStyleData } from '@game-engine/core/types/RenderingTypes';
