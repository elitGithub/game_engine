...
import { SpeakerRegistry } from '@game-engine/core/rendering/SpeakerRegistry';
import { Speaker } from '@game-engine/core/rendering/Speaker';
import type { SpeakerConfig } from '@game-engine/core/types';
