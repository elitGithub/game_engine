...
import { MockAudioPlatform } from '@game-engine/core/platform/audio';
import { MockInputAdapter } from '@game-engine/core/input';
import type { StorageAdapter } from '@game-engine/core/core/StorageAdapter';
import { InMemoryStorageAdapter } from '@game-engine/core/systems/InMemoryStorageAdapter';
import {HeadlessRenderContainer} from "@game-engine/core/interfaces/HeadlessRenderContainer";
