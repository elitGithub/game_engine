...
import { BaseInputAdapter } from '@game-engine/core/input';
import type { InputAdapterType, InputCapabilities, InputAttachOptions, ILogger, IRenderContainer} from '@game-engine/core/interfaces';
import type { ITimerProvider } from '@game-engine/core/interfaces';
import {GamepadAxisEvent, GamepadButtonEvent} from "@game-engine/core/types/InputEvents";
