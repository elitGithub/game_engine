...
import type { IEngineHost, IEnginePlugin, TypedGameContext, ISerializable } from '@game-engine/core/types';
...
export class GameClockPlugin implements IEnginePlugin, ISerializable {
    ...
    update(_deltaTime: number, _context: TypedGameContext<unknown>): void {
